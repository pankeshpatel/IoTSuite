// $ANTLR 3.5.1 S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g 2015-10-24 16:53:27
...
public class NetworkSpecParser extends Parser {
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:23:1: networkspec : 'devices' ':' ( device_def )* ;
	public final void networkspec() throws RecognitionException {
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:23:12: ( 'devices' ':' ( device_def )* )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:24:7: 'devices' ':' ( device_def )*
			{
			match(input,11,FOLLOW_11_in_networkspec58); 
			match(input,9,FOLLOW_9_in_networkspec60); 
			 context = new SymbolTable();
			      
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:27:8: ( device_def )*
			loop1:
			while (true) {
				int alt1=2;
				...
				switch (alt1) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:27:9: device_def
					{
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:30:1: device_def : deviceName= ( ID | CAPITALIZED_ID ) ':' 'region' ':' ( location_def )* 'platform' ':' ( device_type )* ';' 'resources' ':' ( abilities_def )? ';' 'protocol' ':' ( protocol_value )* ';' ;
	public final void device_def() throws RecognitionException {
		Token deviceName=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:30:11: (deviceName= ( ID | CAPITALIZED_ID ) ':' 'region' ':' ( location_def )* 'platform' ':' ( device_type )* ';' 'resources' ':' ( abilities_def )? ';' 'protocol' ':' ( protocol_value )* ';' )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:31:4: deviceName= ( ID | CAPITALIZED_ID ) ':' 'region' ':' ( location_def )* 'platform' ':' ( device_type )* ';' 'resources' ':' ( abilities_def )? ';' 'protocol' ':' ( protocol_value )* ';'
			{
			...
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:36:18: ( location_def )*
			loop2:
			while (true) {
				int alt2=2;
				...
				switch (alt2) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:36:19: location_def
					{
			...
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:37:20: ( device_type )*
			loop3:
			while (true) {
				int alt3=2;
				...
				switch (alt3) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:37:21: device_type
					{
			...
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:38:21: ( abilities_def )?
			int alt4=2;
			...
			switch (alt4) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:38:22: abilities_def
					{
			...
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:39:20: ( protocol_value )*
			loop5:
			while (true) {
				int alt5=2;
				...
				switch (alt5) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:39:21: protocol_value
					{
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:47:1: location_def : CAPITALIZED_ID ':' ID ';' ;
	public final void location_def() throws RecognitionException {
		Token CAPITALIZED_ID1=null;
		Token ID2=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:47:14: ( CAPITALIZED_ID ':' ID ';' )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:48:5: CAPITALIZED_ID ':' ID ';'
			{
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:54:1: device_type : CAPITALIZED_ID ;
	public final void device_type() throws RecognitionException {
		Token CAPITALIZED_ID3=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:54:13: ( CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:55:6: CAPITALIZED_ID
			{
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:60:1: abilities_def : CAPITALIZED_ID ( ',' abilities_def )? ;
	public final void abilities_def() throws RecognitionException {
		Token CAPITALIZED_ID4=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:60:15: ( CAPITALIZED_ID ( ',' abilities_def )? )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:61:4: CAPITALIZED_ID ( ',' abilities_def )?
			{
			CAPITALIZED_ID4=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_abilities_def264); 
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:61:19: ( ',' abilities_def )?
			int alt6=2;
			...
			switch (alt6) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:61:20: ',' abilities_def
					{
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:67:1: mobileFlag_def : 'mobile' ':' MOBILEFLAG ;
	public final void mobileFlag_def() throws RecognitionException {
		Token MOBILEFLAG5=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:67:16: ( 'mobile' ':' MOBILEFLAG )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:68:4: 'mobile' ':' MOBILEFLAG
			{
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:72:1: protocol_value : ID ;
	public final void protocol_value() throws RecognitionException {
		Token ID6=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:72:15: ( ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\ToolSuite\\bin\\iotsuite\\parser\\NetworkSpec.g:73:3: ID
			{
