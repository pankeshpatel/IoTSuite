// $ANTLR 3.5.1 S:\\Thesis\\DevelopmentFramework\\IoTSuite\\ToolSuite\\src\\iotsuite\\parser\\ArchSpec.g 2015-07-20 14:05:27
...
public class ArchSpecParser extends Parser {
	...
	// $ANTLR start "cs_def"
	// S:\\Thesis\\DevelopmentFramework\\IoTSuite\\ToolSuite\\src\\iotsuite\\parser\\ArchSpec.g:54:1: cs_def : CAPITALIZED_ID ( csConsumeInfo_def ';' )* ( csRequest_def ';' )* ( csGeneratedInfo_def ';' )* ( cntrlCommand_def ';' )* ( partition_def ';' )+ ;
	public final void cs_def() throws RecognitionException {
		Token CAPITALIZED_ID4=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\IoTSuite\\ToolSuite\\src\\iotsuite\\parser\\ArchSpec.g:54:7: ( CAPITALIZED_ID ( csConsumeInfo_def ';' )* ( csRequest_def ';' )* ( csGeneratedInfo_def ';' )* ( cntrlCommand_def ';' )* ( partition_def ';' )+ )
			// S:\\Thesis\\DevelopmentFramework\\IoTSuite\\ToolSuite\\src\\iotsuite\\parser\\ArchSpec.g:55:3: CAPITALIZED_ID ( csConsumeInfo_def ';' )* ( csRequest_def ';' )* ( csGeneratedInfo_def ';' )* ( cntrlCommand_def ';' )* ( partition_def ';' )+
			{
			...
			// S:\\Thesis\\DevelopmentFramework\\IoTSuite\\ToolSuite\\src\\iotsuite\\parser\\ArchSpec.g:61:6: ( csGeneratedInfo_def ';' )*
			loop7:
			while (true) {
				int alt7=2;
				...
				switch (alt7) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\IoTSuite\\ToolSuite\\src\\iotsuite\\parser\\ArchSpec.g:61:7: csGeneratedInfo_def ';'
					{
					pushFollow(FOLLOW_csGeneratedInfo_def_in_cs_def258);
					csGeneratedInfo_def();
					state._fsp--;

					match(input,11,FOLLOW_11_in_cs_def260); 
					}
					break;
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_cntrlCommand_def_in_cs_def269);
					cntrlCommand_def();
					state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_partition_def_in_cs_def281);
					partition_def();
					state._fsp--;

					match(input,11,FOLLOW_11_in_cs_def283); 
					}
					break;
	...
	public final void csGeneratedInfo_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,21,FOLLOW_21_in_csGeneratedInfo_def308); 
			pushFollow(FOLLOW_lc_id_in_csGeneratedInfo_def310);
			lc_id5=lc_id();
			state._fsp--;

			match(input,10,FOLLOW_10_in_csGeneratedInfo_def312); 
			CAPITALIZED_ID6=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csGeneratedInfo_def315); 
	...
	public final void csConsumeInfo_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,18,FOLLOW_18_in_csConsumeInfo_def341); 
			pushFollow(FOLLOW_lc_id_in_csConsumeInfo_def343);
			lc_id7=lc_id();
			state._fsp--;

			match(input,20,FOLLOW_20_in_csConsumeInfo_def345); 
			match(input,24,FOLLOW_24_in_csConsumeInfo_def347); 
			match(input,10,FOLLOW_10_in_csConsumeInfo_def349); 
			match(input,INT,FOLLOW_INT_in_csConsumeInfo_def351); 
			match(input,10,FOLLOW_10_in_csConsumeInfo_def353); 
			match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csConsumeInfo_def355); 
	...
	public final void csRequest_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,25,FOLLOW_25_in_csRequest_def383); 
			pushFollow(FOLLOW_lc_id_in_csRequest_def385);
			lc_id8=lc_id();
			state._fsp--;
	...
	public final void cntrlCommand_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,16,FOLLOW_16_in_cntrlCommand_def407); 
			name=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def414); 
			match(input,8,FOLLOW_8_in_cntrlCommand_def416); 
			...
			switch (alt10) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_cntrlParameter_def_in_cntrlCommand_def419);
					cntrlParameter_def();
					state._fsp--;
			...
			match(input,9,FOLLOW_9_in_cntrlCommand_def423); 
			match(input,28,FOLLOW_28_in_cntrlCommand_def425); 
			match(input,24,FOLLOW_24_in_cntrlCommand_def428); 
			match(input,10,FOLLOW_10_in_cntrlCommand_def430); 
			match(input,INT,FOLLOW_INT_in_cntrlCommand_def432); 
			match(input,10,FOLLOW_10_in_cntrlCommand_def434); 
			match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def436); 
	...
	public final void cntrlParameter_def() throws RecognitionException {
		...
		try {
			...
			{
			pushFollow(FOLLOW_lc_id_in_cntrlParameter_def460);
			lc_id9=lc_id();
			state._fsp--;
	...
	public final void partition_def() throws RecognitionException {
		...
		try {
			...
			{
			csDeploymentConstraint=(Token)match(input,23,FOLLOW_23_in_partition_def493); 
			match(input,10,FOLLOW_10_in_partition_def495); 
			CAPITALIZED_ID10=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_partition_def497); 
	...
	public final ArchSpecParser.lc_id_return lc_id() throws RecognitionException {
		...
		try {
			...
			{
			match(input,ID,FOLLOW_ID_in_lc_id515); 
			}
	...
	public final ArchSpecParser.dataType_return dataType() throws RecognitionException {
		...
		try {
			...
			{
			pushFollow(FOLLOW_primitiveType_in_dataType529);
			primitiveType();
			state._fsp--;
	...
	public static final BitSet FOLLOW_11_in_cs_def248 = new BitSet(new long[]{0x0000000002A10000L});
	public static final BitSet FOLLOW_csGeneratedInfo_def_in_cs_def258 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_cs_def260 = new BitSet(new long[]{0x0000000000A10000L});
	public static final BitSet FOLLOW_cntrlCommand_def_in_cs_def269 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_cs_def271 = new BitSet(new long[]{0x0000000000810000L});
	public static final BitSet FOLLOW_partition_def_in_cs_def281 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_cs_def283 = new BitSet(new long[]{0x0000000000800002L});
	public static final BitSet FOLLOW_21_in_csGeneratedInfo_def308 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_csGeneratedInfo_def310 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_csGeneratedInfo_def312 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csGeneratedInfo_def315 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_18_in_csConsumeInfo_def341 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_csConsumeInfo_def343 = new BitSet(new long[]{0x0000000000100000L});
	public static final BitSet FOLLOW_20_in_csConsumeInfo_def345 = new BitSet(new long[]{0x0000000001000000L});
	public static final BitSet FOLLOW_24_in_csConsumeInfo_def347 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_csConsumeInfo_def349 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_INT_in_csConsumeInfo_def351 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_csConsumeInfo_def353 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csConsumeInfo_def355 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_25_in_csRequest_def383 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_csRequest_def385 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_16_in_cntrlCommand_def407 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def414 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_cntrlCommand_def416 = new BitSet(new long[]{0x0000000000000220L});
	public static final BitSet FOLLOW_cntrlParameter_def_in_cntrlCommand_def419 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_cntrlCommand_def423 = new BitSet(new long[]{0x0000000010000000L});
	public static final BitSet FOLLOW_28_in_cntrlCommand_def425 = new BitSet(new long[]{0x0000000001000000L});
	public static final BitSet FOLLOW_24_in_cntrlCommand_def428 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_cntrlCommand_def430 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_INT_in_cntrlCommand_def432 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_cntrlCommand_def434 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def436 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_lc_id_in_cntrlParameter_def460 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_23_in_partition_def493 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_partition_def495 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_partition_def497 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_lc_id515 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_primitiveType_in_dataType529 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_13_in_primitiveType544 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_12_in_primitiveType550 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_14_in_primitiveType556 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_19_in_primitiveType565 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_22_in_primitiveType573 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_15_in_primitiveType579 = new BitSet(new long[]{0x0000000000000002L});
}
