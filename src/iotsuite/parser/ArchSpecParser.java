<<<<<<< HEAD
// $ANTLR 3.5.1 S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g 2015-11-19 18:12:25
...
<<<<<<< HEAD
	public static final String[] tokenNames = new String[] { "<invalid>",
			...
			"'('", "')'", "','", "':'", "';'", "'Boolean'", "'COMPUTE('",
			"'Custom'", "'InBuilt'", "'Integer'", "'String'", "'_BY_SAMPLE'",
...
<<<<<<< HEAD
		...
		try {
			...
			// component_def )+
			{
				...
				loop2: while (true) {
					...
					switch (alt2) {
					case 1:
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:28:32:
					// component_def
					{
		...
		try {
			...
			// CAPITALIZED_ID ( structField_def ';' )+
			{
				CAPITALIZED_ID1 = (Token) match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_struct_def150);
	...
	public final void structField_def() throws RecognitionException {
		...
		try {
			...
			// lc_id ':' dataType
			{
				pushFollow(FOLLOW_lc_id_in_structField_def189);
				lc_id2 = lc_id();
				state._fsp--;

				match(input, 11, FOLLOW_11_in_structField_def191);
				pushFollow(FOLLOW_dataType_in_structField_def193);
				dataType3 = dataType();
				state._fsp--;
	...
	// cs_def : 'InBuilt' ':' ( agg_cs_def )* 'Custom' ':' ( controller_def )* ;
	public final void cs_def() throws RecognitionException {
		try {
			...
			// ( 'InBuilt' ':' ( agg_cs_def )* 'Custom' ':' ( controller_def )*
			// )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:48:5:
			// 'InBuilt' ':' ( agg_cs_def )* 'Custom' ':' ( controller_def )*
			{
				match(input, 16, FOLLOW_16_in_cs_def220);
				match(input, 11, FOLLOW_11_in_cs_def222);
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:49:8:
				// ( agg_cs_def )*
				loop4: while (true) {
					int alt4 = 2;
					...
					switch (alt4) {
					case 1:
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:49:9:
					// agg_cs_def
					{
						pushFollow(FOLLOW_agg_cs_def_in_cs_def234);
						agg_cs_def();
						state._fsp--;
				...
				match(input, 15, FOLLOW_15_in_cs_def244);
				match(input, 11, FOLLOW_11_in_cs_def246);
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:51:9:
				// ( controller_def )*
				loop5: while (true) {
					int alt5 = 2;
					...
					switch (alt5) {
					case 1:
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:51:10:
					// controller_def
					{
						pushFollow(FOLLOW_controller_def_in_cs_def258);
						controller_def();
						state._fsp--;
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:58:1:
	...
	public final void agg_cs_def() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:58:11:
			// ( CAPITALIZED_ID ( csConsumeInfo_def ';' )* ( csOperation_def ';'
			// )* ( csGeneratedInfoForAggregator_def ';' )* )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:60:2:
			// CAPITALIZED_ID ( csConsumeInfo_def ';' )* ( csOperation_def ';'
			// )* ( csGeneratedInfoForAggregator_def ';' )*
			{
				CAPITALIZED_ID4 = (Token) match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_agg_cs_def302);
				...
				context.currentMappingConstraint
						.setSoftwareComponentName((CAPITALIZED_ID4 != null ? CAPITALIZED_ID4
								.getText() : null));
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:64:5:
				// ( csConsumeInfo_def ';' )*
				loop6: while (true) {
					int alt6 = 2;
					...
					switch (alt6) {
					case 1:
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:64:6:
					// csConsumeInfo_def ';'
					{
						pushFollow(FOLLOW_csConsumeInfo_def_in_agg_cs_def316);
						csConsumeInfo_def();
						state._fsp--;

						match(input, 12, FOLLOW_12_in_agg_cs_def318);
					}
						break;
				...
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:65:5:
				// ( csOperation_def ';' )*
				loop7: while (true) {
					int alt7 = 2;
					...
					switch (alt7) {
					case 1:
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:65:6:
					// csOperation_def ';'
					{
						pushFollow(FOLLOW_csOperation_def_in_agg_cs_def328);
						csOperation_def();
						state._fsp--;

						match(input, 12, FOLLOW_12_in_agg_cs_def330);
					}
						break;
				...
				loop8: while (true) {
					...
					// csGeneratedInfoForAggregator_def ';'
					{
						pushFollow(FOLLOW_csGeneratedInfoForAggregator_def_in_agg_cs_def339);
						csGeneratedInfoForAggregator_def();
						state._fsp--;
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:99:1:
	...
	public final void controller_def() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:99:15:
			// ( CAPITALIZED_ID ( csConsumeInfo_def ';' )* ( csRequest_def ';'
			// )* ( csGeneratedInfo_def ';' )* ( cntrlCommand_def ';' )* )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:101:2:
			// CAPITALIZED_ID ( csConsumeInfo_def ';' )* ( csRequest_def ';' )*
			// ( csGeneratedInfo_def ';' )* ( cntrlCommand_def ';' )*
			{
				CAPITALIZED_ID5 = (Token) match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_controller_def390);
				...
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:106:5:
				// ( csConsumeInfo_def ';' )*
				loop9: while (true) {
					int alt9 = 2;
					...
					switch (alt9) {
					case 1:
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:106:6:
					// csConsumeInfo_def ';'
					{
						pushFollow(FOLLOW_csConsumeInfo_def_in_controller_def404);
						csConsumeInfo_def();
						state._fsp--;

						match(input, 12, FOLLOW_12_in_controller_def406);
					}
						break;
				...
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:107:6:
				// ( csRequest_def ';' )*
				loop10: while (true) {
					int alt10 = 2;
					...
					switch (alt10) {
					case 1:
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:107:7:
					// csRequest_def ';'
					{
						pushFollow(FOLLOW_csRequest_def_in_controller_def418);
						csRequest_def();
						state._fsp--;

						match(input, 12, FOLLOW_12_in_controller_def420);
					}
						break;
				...
				loop11: while (true) {
					...
					// csGeneratedInfo_def ';'
					{
						pushFollow(FOLLOW_csGeneratedInfo_def_in_controller_def431);
						csGeneratedInfo_def();
						state._fsp--;

						match(input, 12, FOLLOW_12_in_controller_def433);
					}
						break;
				...
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:109:5:
				// ( cntrlCommand_def ';' )*
				loop12: while (true) {
					int alt12 = 2;
					...
					// cntrlCommand_def ';'
					{
						pushFollow(FOLLOW_cntrlCommand_def_in_controller_def445);
						cntrlCommand_def();
						state._fsp--;

						match(input, 12, FOLLOW_12_in_controller_def447);
					}
						break;
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:121:1:
	...
	public final void csOperation_def() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:121:17:
			// ( 'COMPUTE(' CAPITALIZED_ID '_BY_SAMPLE' ',' INT ')' )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:122:5:
			// 'COMPUTE(' CAPITALIZED_ID '_BY_SAMPLE' ',' INT ')'
			{
				match(input, 14, FOLLOW_14_in_csOperation_def478);
				CAPITALIZED_ID6 = (Token) match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_csOperation_def480);
				match(input, 19, FOLLOW_19_in_csOperation_def481);
				match(input, 10, FOLLOW_10_in_csOperation_def483);
				INT7 = (Token) match(input, INT,
						FOLLOW_INT_in_csOperation_def485);
				match(input, 9, FOLLOW_9_in_csOperation_def487);
				context.currentComputationalService
						.addOperation(
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:126:1:
	...
	public final void csGeneratedInfoForAggregator_def()
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:126:33:
			// ( 'generate' lc_id ':' CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:127:2:
			// 'generate' lc_id ':' CAPITALIZED_ID
			{
				match(input, 26,
						FOLLOW_26_in_csGeneratedInfoForAggregator_def508);
				pushFollow(FOLLOW_lc_id_in_csGeneratedInfoForAggregator_def510);
				lc_id8 = lc_id();
				state._fsp--;

				match(input, 11,
						FOLLOW_11_in_csGeneratedInfoForAggregator_def512);
				CAPITALIZED_ID9 = (Token) match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_csGeneratedInfoForAggregator_def515);
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:137:1:
	...
	public final void csGeneratedInfo_def() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:137:20:
			// ( 'generate' lc_id ':' CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:138:5:
			// 'generate' lc_id ':' CAPITALIZED_ID
			{
				match(input, 26, FOLLOW_26_in_csGeneratedInfo_def534);
				pushFollow(FOLLOW_lc_id_in_csGeneratedInfo_def536);
				lc_id10 = lc_id();
				state._fsp--;

				match(input, 11, FOLLOW_11_in_csGeneratedInfo_def538);
				CAPITALIZED_ID11 = (Token) match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_csGeneratedInfo_def541);
				context.currentComputationalService.addGeneratedInfo(
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:145:1:
	...
	public final void csConsumeInfo_def() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:145:18:
			// ( 'consume' lc_id 'from' CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:147:5:
			// 'consume' lc_id 'from' CAPITALIZED_ID
			{
				match(input, 23, FOLLOW_23_in_csConsumeInfo_def569);
				pushFollow(FOLLOW_lc_id_in_csConsumeInfo_def571);
				lc_id12 = lc_id();
				state._fsp--;

				match(input, 25, FOLLOW_25_in_csConsumeInfo_def574);
				match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_csConsumeInfo_def577);
				context.currentComputationalService
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:152:1:
	...
	public final void csRequest_def() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:152:15:
			// ( 'request' lc_id 'to' CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:153:4:
			// 'request' lc_id 'to' CAPITALIZED_ID
			{
				match(input, 28, FOLLOW_28_in_csRequest_def608);
				pushFollow(FOLLOW_lc_id_in_csRequest_def610);
				lc_id13 = lc_id();
				state._fsp--;

				match(input, 31, FOLLOW_31_in_csRequest_def612);
				match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_csRequest_def614);
				context.currentComputationalService
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:158:1:
	...
	public final void cntrlCommand_def() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:158:18:
			// ( 'command' name= CAPITALIZED_ID '(' ( cntrlParameter_def )? ')'
			// 'to' CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:160:6:
			// 'command' name= CAPITALIZED_ID '(' ( cntrlParameter_def )? ')'
			// 'to' CAPITALIZED_ID
			{
				match(input, 21, FOLLOW_21_in_cntrlCommand_def641);
				name = (Token) match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def648);
				match(input, 8, FOLLOW_8_in_cntrlCommand_def650);
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:160:43:
				// ( cntrlParameter_def )?
				int alt13 = 2;
				...
				switch (alt13) {
				case 1:
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:160:44:
				// cntrlParameter_def
				{
=======
	...
	public final void agg_cs_def() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID4=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_agg_cs_def302); 
	...
	public final void controller_def() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID5=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_controller_def390); 
	...
	public final void csOperation_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,14,FOLLOW_14_in_csOperation_def478); 
			CAPITALIZED_ID6=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csOperation_def480); 
			match(input,19,FOLLOW_19_in_csOperation_def481); 
			match(input,10,FOLLOW_10_in_csOperation_def483); 
			INT7=(Token)match(input,INT,FOLLOW_INT_in_csOperation_def485); 
			match(input,9,FOLLOW_9_in_csOperation_def487); 
	...
	public final void csGeneratedInfoForAggregator_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,26,FOLLOW_26_in_csGeneratedInfoForAggregator_def508); 
			pushFollow(FOLLOW_lc_id_in_csGeneratedInfoForAggregator_def510);
			lc_id8=lc_id();
			state._fsp--;

			match(input,11,FOLLOW_11_in_csGeneratedInfoForAggregator_def512); 
			CAPITALIZED_ID9=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csGeneratedInfoForAggregator_def515); 
	...
	public final void csGeneratedInfo_def() throws RecognitionException {
		...
		try {
			...
			match(input,11,FOLLOW_11_in_csGeneratedInfo_def538); 
			CAPITALIZED_ID11=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csGeneratedInfo_def541); 
	...
	public final void csConsumeInfo_def() throws RecognitionException {
		...
		try {
			...
			match(input,25,FOLLOW_25_in_csConsumeInfo_def574); 
			match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csConsumeInfo_def577); 
	...
	public final void csRequest_def() throws RecognitionException {
		...
		try {
			...
			match(input,31,FOLLOW_31_in_csRequest_def612); 
			match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csRequest_def614); 
	...
	public final void cntrlCommand_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,21,FOLLOW_21_in_cntrlCommand_def641); 
			name=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def648); 
			match(input,8,FOLLOW_8_in_cntrlCommand_def650); 
			...
			switch (alt13) {
				case 1 :
					...
					{
>>>>>>> f18db808215aa7c0212c33614ab0a8c9dea732b4
					pushFollow(FOLLOW_cntrlParameter_def_in_cntrlCommand_def653);
					cntrlParameter_def();
					state._fsp--;
...
<<<<<<< HEAD
				...
				match(input, 9, FOLLOW_9_in_cntrlCommand_def657);
				match(input, 31, FOLLOW_31_in_cntrlCommand_def659);
				match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def662);
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:166:1:
	...
	public final void cntrlParameter_def() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:166:20:
			// ( lc_id )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:167:5:
			// lc_id
			{
				pushFollow(FOLLOW_lc_id_in_cntrlParameter_def681);
				lc_id14 = lc_id();
				state._fsp--;
	...
	// $ANTLR start "lc_id"
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:180:1:
	// lc_id : ID ;
...
=======
			...
			match(input,9,FOLLOW_9_in_cntrlCommand_def657); 
			match(input,31,FOLLOW_31_in_cntrlCommand_def659); 
			match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def662); 
...
>>>>>>> f18db808215aa7c0212c33614ab0a8c9dea732b4
		...
		try {
<<<<<<< HEAD
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:180:6:
			// ( ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:180:8:
			// ID
			{
				match(input, ID, FOLLOW_ID_in_lc_id713);
=======
...
<<<<<<< HEAD
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:183:1:
...
>>>>>>> f18db808215aa7c0212c33614ab0a8c9dea732b4
		...
		try {
<<<<<<< HEAD
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:183:9:
			// ( primitiveType )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:184:3:
			// primitiveType
			{
				pushFollow(FOLLOW_primitiveType_in_dataType727);
				primitiveType();
				state._fsp--;
=======
...
<<<<<<< HEAD
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:187:1:
	...
	public final void primitiveType() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:187:14:
			// ( (id= 'Integer' |id= 'Boolean' |id= 'String' |id= 'double' |id=
			// 'long' |id= 'boolean' ) )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:188:3:
			// (id= 'Integer' |id= 'Boolean' |id= 'String' |id= 'double' |id=
			// 'long' |id= 'boolean' )
			{
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:188:3:
				...
				switch (alt14) {
				case 1:
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:188:4:
				// id= 'Integer'
				{
					id = (Token) match(input, 17, FOLLOW_17_in_primitiveType742);
				}
					break;
				case 2:
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:188:19:
				// id= 'Boolean'
				{
					id = (Token) match(input, 13, FOLLOW_13_in_primitiveType748);
				}
					break;
				case 3:
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:188:34:
				// id= 'String'
				{
					id = (Token) match(input, 18, FOLLOW_18_in_primitiveType754);
				}
					break;
				case 4:
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:188:49:
				// id= 'double'
				{
					id = (Token) match(input, 24, FOLLOW_24_in_primitiveType763);
				}
					break;
				case 5:
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:188:65:
				// id= 'long'
				{
					id = (Token) match(input, 27, FOLLOW_27_in_primitiveType771);
				}
					break;
				case 6:
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:188:79:
				// id= 'boolean'
				{
					id = (Token) match(input, 20, FOLLOW_20_in_primitiveType777);
				}
					break;
...
<<<<<<< HEAD
	public static final BitSet FOLLOW_30_in_archSpec86 = new BitSet(
	...
	public static final BitSet FOLLOW_29_in_archSpec101 = new BitSet(
			new long[] { 0x0000000000000800L });
	...
	public static final BitSet FOLLOW_22_in_component_def128 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_component_def130 = new BitSet(
			new long[] { 0x0000000000010000L });
	public static final BitSet FOLLOW_cs_def_in_component_def133 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_struct_def150 = new BitSet(
			new long[] { 0x0000000000000020L });
	public static final BitSet FOLLOW_structField_def_in_struct_def164 = new BitSet(
			new long[] { 0x0000000000001000L });
	public static final BitSet FOLLOW_12_in_struct_def166 = new BitSet(
			new long[] { 0x0000000000000022L });
	public static final BitSet FOLLOW_lc_id_in_structField_def189 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_structField_def191 = new BitSet(
			new long[] { 0x0000000009162000L });
	public static final BitSet FOLLOW_dataType_in_structField_def193 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_16_in_cs_def220 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_cs_def222 = new BitSet(
			new long[] { 0x0000000000008010L });
	public static final BitSet FOLLOW_agg_cs_def_in_cs_def234 = new BitSet(
			new long[] { 0x0000000000008010L });
	public static final BitSet FOLLOW_15_in_cs_def244 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_cs_def246 = new BitSet(
			new long[] { 0x0000000000000012L });
	public static final BitSet FOLLOW_controller_def_in_cs_def258 = new BitSet(
			new long[] { 0x0000000000000012L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_agg_cs_def302 = new BitSet(
			new long[] { 0x0000000004804002L });
	public static final BitSet FOLLOW_csConsumeInfo_def_in_agg_cs_def316 = new BitSet(
			new long[] { 0x0000000000001000L });
	public static final BitSet FOLLOW_12_in_agg_cs_def318 = new BitSet(
			new long[] { 0x0000000004804002L });
	public static final BitSet FOLLOW_csOperation_def_in_agg_cs_def328 = new BitSet(
			new long[] { 0x0000000000001000L });
	public static final BitSet FOLLOW_12_in_agg_cs_def330 = new BitSet(
			new long[] { 0x0000000004004002L });
	public static final BitSet FOLLOW_csGeneratedInfoForAggregator_def_in_agg_cs_def339 = new BitSet(
			new long[] { 0x0000000000001000L });
	public static final BitSet FOLLOW_12_in_agg_cs_def341 = new BitSet(
			new long[] { 0x0000000004000002L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_controller_def390 = new BitSet(
			new long[] { 0x0000000014A00002L });
	public static final BitSet FOLLOW_csConsumeInfo_def_in_controller_def404 = new BitSet(
			new long[] { 0x0000000000001000L });
	public static final BitSet FOLLOW_12_in_controller_def406 = new BitSet(
			new long[] { 0x0000000014A00002L });
	public static final BitSet FOLLOW_csRequest_def_in_controller_def418 = new BitSet(
			new long[] { 0x0000000000001000L });
	public static final BitSet FOLLOW_12_in_controller_def420 = new BitSet(
			new long[] { 0x0000000014200002L });
	public static final BitSet FOLLOW_csGeneratedInfo_def_in_controller_def431 = new BitSet(
			new long[] { 0x0000000000001000L });
	public static final BitSet FOLLOW_12_in_controller_def433 = new BitSet(
			new long[] { 0x0000000004200002L });
	public static final BitSet FOLLOW_cntrlCommand_def_in_controller_def445 = new BitSet(
			new long[] { 0x0000000000001000L });
	public static final BitSet FOLLOW_12_in_controller_def447 = new BitSet(
			new long[] { 0x0000000000200002L });
	public static final BitSet FOLLOW_14_in_csOperation_def478 = new BitSet(
			new long[] { 0x0000000000000010L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csOperation_def480 = new BitSet(
			new long[] { 0x0000000000080000L });
	public static final BitSet FOLLOW_19_in_csOperation_def481 = new BitSet(
			new long[] { 0x0000000000000400L });
	public static final BitSet FOLLOW_10_in_csOperation_def483 = new BitSet(
			new long[] { 0x0000000000000040L });
	public static final BitSet FOLLOW_INT_in_csOperation_def485 = new BitSet(
			new long[] { 0x0000000000000200L });
	public static final BitSet FOLLOW_9_in_csOperation_def487 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_26_in_csGeneratedInfoForAggregator_def508 = new BitSet(
			new long[] { 0x0000000000000020L });
	public static final BitSet FOLLOW_lc_id_in_csGeneratedInfoForAggregator_def510 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_csGeneratedInfoForAggregator_def512 = new BitSet(
			new long[] { 0x0000000000000010L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csGeneratedInfoForAggregator_def515 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_26_in_csGeneratedInfo_def534 = new BitSet(
			new long[] { 0x0000000000000020L });
	public static final BitSet FOLLOW_lc_id_in_csGeneratedInfo_def536 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_csGeneratedInfo_def538 = new BitSet(
			new long[] { 0x0000000000000010L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csGeneratedInfo_def541 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_23_in_csConsumeInfo_def569 = new BitSet(
			new long[] { 0x0000000000000020L });
	public static final BitSet FOLLOW_lc_id_in_csConsumeInfo_def571 = new BitSet(
			new long[] { 0x0000000002000000L });
	public static final BitSet FOLLOW_25_in_csConsumeInfo_def574 = new BitSet(
			new long[] { 0x0000000000000010L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csConsumeInfo_def577 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_28_in_csRequest_def608 = new BitSet(
			new long[] { 0x0000000000000020L });
	public static final BitSet FOLLOW_lc_id_in_csRequest_def610 = new BitSet(
			new long[] { 0x0000000080000000L });
	public static final BitSet FOLLOW_31_in_csRequest_def612 = new BitSet(
			new long[] { 0x0000000000000010L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csRequest_def614 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_21_in_cntrlCommand_def641 = new BitSet(
			new long[] { 0x0000000000000010L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def648 = new BitSet(
			new long[] { 0x0000000000000100L });
	public static final BitSet FOLLOW_8_in_cntrlCommand_def650 = new BitSet(
			new long[] { 0x0000000000000220L });
	public static final BitSet FOLLOW_cntrlParameter_def_in_cntrlCommand_def653 = new BitSet(
			new long[] { 0x0000000000000200L });
	public static final BitSet FOLLOW_9_in_cntrlCommand_def657 = new BitSet(
			new long[] { 0x0000000080000000L });
	public static final BitSet FOLLOW_31_in_cntrlCommand_def659 = new BitSet(
			new long[] { 0x0000000000000010L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def662 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_lc_id_in_cntrlParameter_def681 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_ID_in_lc_id713 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_primitiveType_in_dataType727 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_17_in_primitiveType742 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_13_in_primitiveType748 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_18_in_primitiveType754 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_24_in_primitiveType763 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_27_in_primitiveType771 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_20_in_primitiveType777 = new BitSet(
			new long[] { 0x0000000000000002L });
=======
	...
	public static final BitSet FOLLOW_lc_id_in_structField_def189 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_structField_def191 = new BitSet(new long[]{0x0000000009162000L});
	public static final BitSet FOLLOW_dataType_in_structField_def193 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_16_in_cs_def220 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_cs_def222 = new BitSet(new long[]{0x0000000000008010L});
	public static final BitSet FOLLOW_agg_cs_def_in_cs_def234 = new BitSet(new long[]{0x0000000000008010L});
	public static final BitSet FOLLOW_15_in_cs_def244 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_cs_def246 = new BitSet(new long[]{0x0000000000000012L});
	public static final BitSet FOLLOW_controller_def_in_cs_def258 = new BitSet(new long[]{0x0000000000000012L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_agg_cs_def302 = new BitSet(new long[]{0x0000000004804002L});
	public static final BitSet FOLLOW_csConsumeInfo_def_in_agg_cs_def316 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_agg_cs_def318 = new BitSet(new long[]{0x0000000004804002L});
	public static final BitSet FOLLOW_csOperation_def_in_agg_cs_def328 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_agg_cs_def330 = new BitSet(new long[]{0x0000000004004002L});
	public static final BitSet FOLLOW_csGeneratedInfoForAggregator_def_in_agg_cs_def339 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_agg_cs_def341 = new BitSet(new long[]{0x0000000004000002L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_controller_def390 = new BitSet(new long[]{0x0000000014A00002L});
	public static final BitSet FOLLOW_csConsumeInfo_def_in_controller_def404 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_controller_def406 = new BitSet(new long[]{0x0000000014A00002L});
	public static final BitSet FOLLOW_csRequest_def_in_controller_def418 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_controller_def420 = new BitSet(new long[]{0x0000000014200002L});
	public static final BitSet FOLLOW_csGeneratedInfo_def_in_controller_def431 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_controller_def433 = new BitSet(new long[]{0x0000000004200002L});
	public static final BitSet FOLLOW_cntrlCommand_def_in_controller_def445 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_controller_def447 = new BitSet(new long[]{0x0000000000200002L});
	public static final BitSet FOLLOW_14_in_csOperation_def478 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csOperation_def480 = new BitSet(new long[]{0x0000000000080000L});
	public static final BitSet FOLLOW_19_in_csOperation_def481 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_csOperation_def483 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_INT_in_csOperation_def485 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_csOperation_def487 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_26_in_csGeneratedInfoForAggregator_def508 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_csGeneratedInfoForAggregator_def510 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_csGeneratedInfoForAggregator_def512 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csGeneratedInfoForAggregator_def515 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_26_in_csGeneratedInfo_def534 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_csGeneratedInfo_def536 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_csGeneratedInfo_def538 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csGeneratedInfo_def541 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_23_in_csConsumeInfo_def569 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_csConsumeInfo_def571 = new BitSet(new long[]{0x0000000002000000L});
	public static final BitSet FOLLOW_25_in_csConsumeInfo_def574 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csConsumeInfo_def577 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_28_in_csRequest_def608 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_csRequest_def610 = new BitSet(new long[]{0x0000000080000000L});
	public static final BitSet FOLLOW_31_in_csRequest_def612 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csRequest_def614 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_21_in_cntrlCommand_def641 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def648 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_cntrlCommand_def650 = new BitSet(new long[]{0x0000000000000220L});
	public static final BitSet FOLLOW_cntrlParameter_def_in_cntrlCommand_def653 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_cntrlCommand_def657 = new BitSet(new long[]{0x0000000080000000L});
	public static final BitSet FOLLOW_31_in_cntrlCommand_def659 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def662 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_lc_id_in_cntrlParameter_def681 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_lc_id713 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_primitiveType_in_dataType727 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_17_in_primitiveType742 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_13_in_primitiveType748 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_18_in_primitiveType754 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_24_in_primitiveType763 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_27_in_primitiveType771 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_20_in_primitiveType777 = new BitSet(new long[]{0x0000000000000002L});
>>>>>>> f18db808215aa7c0212c33614ab0a8c9dea732b4
}
