// $ANTLR 3.5.1 S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g 2016-01-16 23:23:30
...
public class ArchSpecParser extends Parser {
	...
	public final void agg_cs_def() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID4=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_agg_cs_def321); 
	...
	public final void controller_def() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID5=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_controller_def409); 
	...
	public final void csOperation_def() throws RecognitionException {
		...
		try {
			...
			match(input,8,FOLLOW_8_in_csOperation_def499); 
			CAPITALIZED_ID6=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csOperation_def501); 
			match(input,19,FOLLOW_19_in_csOperation_def502); 
			match(input,10,FOLLOW_10_in_csOperation_def505); 
			INT7=(Token)match(input,INT,FOLLOW_INT_in_csOperation_def507); 
			match(input,9,FOLLOW_9_in_csOperation_def509); 
	...
	public final void csGeneratedInfoForAggregator_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,26,FOLLOW_26_in_csGeneratedInfoForAggregator_def533); 
			pushFollow(FOLLOW_lc_id_in_csGeneratedInfoForAggregator_def535);
			lc_id8=lc_id();
			state._fsp--;

			match(input,11,FOLLOW_11_in_csGeneratedInfoForAggregator_def537); 
			CAPITALIZED_ID9=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csGeneratedInfoForAggregator_def540); 
	...
	public final void csGeneratedInfo_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,26,FOLLOW_26_in_csGeneratedInfo_def559); 
			pushFollow(FOLLOW_lc_id_in_csGeneratedInfo_def561);
			lc_id10=lc_id();
			state._fsp--;

			match(input,11,FOLLOW_11_in_csGeneratedInfo_def563); 
			CAPITALIZED_ID11=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csGeneratedInfo_def566); 
	...
	public final void csConsumeInfo_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,23,FOLLOW_23_in_csConsumeInfo_def594); 
			pushFollow(FOLLOW_lc_id_in_csConsumeInfo_def596);
			lc_id12=lc_id();
			state._fsp--;

			match(input,25,FOLLOW_25_in_csConsumeInfo_def599); 
			match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csConsumeInfo_def602); 
	...
	public final void csRequest_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,28,FOLLOW_28_in_csRequest_def633); 
			pushFollow(FOLLOW_lc_id_in_csRequest_def635);
			lc_id13=lc_id();
			state._fsp--;

			match(input,31,FOLLOW_31_in_csRequest_def637); 
			match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csRequest_def639); 
	...
	public final void cntrlCommand_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,21,FOLLOW_21_in_cntrlCommand_def666); 
			name=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def673); 
			match(input,8,FOLLOW_8_in_cntrlCommand_def675); 
			...
			switch (alt14) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_cntrlParameter_def_in_cntrlCommand_def678);
					cntrlParameter_def();
					state._fsp--;
			...
			match(input,9,FOLLOW_9_in_cntrlCommand_def682); 
			match(input,31,FOLLOW_31_in_cntrlCommand_def684); 
			match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def687); 
	...
	public final void cntrlParameter_def() throws RecognitionException {
		...
		try {
			...
			{
			pushFollow(FOLLOW_lc_id_in_cntrlParameter_def706);
			lc_id14=lc_id();
			state._fsp--;
	...
	public final ArchSpecParser.lc_id_return lc_id() throws RecognitionException {
		...
		try {
			...
			{
			match(input,ID,FOLLOW_ID_in_lc_id738); 
			}
	...
	public final ArchSpecParser.dataType_return dataType() throws RecognitionException {
		...
		try {
			...
			{
			pushFollow(FOLLOW_primitiveType_in_dataType753);
			primitiveType();
			state._fsp--;
	...
	public static final BitSet FOLLOW_15_in_cs_def225 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_cs_def227 = new BitSet(new long[]{0x0000000000018010L});
	public static final BitSet FOLLOW_agg_cs_def_in_cs_def247 = new BitSet(new long[]{0x0000000000010010L});
	public static final BitSet FOLLOW_16_in_cs_def255 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_cs_def257 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_controller_def_in_cs_def274 = new BitSet(new long[]{0x0000000000000012L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_agg_cs_def321 = new BitSet(new long[]{0x0000000004804002L});
	public static final BitSet FOLLOW_csConsumeInfo_def_in_agg_cs_def335 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_agg_cs_def337 = new BitSet(new long[]{0x0000000004804002L});
	public static final BitSet FOLLOW_csOperation_def_in_agg_cs_def347 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_agg_cs_def349 = new BitSet(new long[]{0x0000000004004002L});
	public static final BitSet FOLLOW_csGeneratedInfoForAggregator_def_in_agg_cs_def358 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_agg_cs_def360 = new BitSet(new long[]{0x0000000004000002L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_controller_def409 = new BitSet(new long[]{0x0000000014A00002L});
	public static final BitSet FOLLOW_csConsumeInfo_def_in_controller_def423 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_controller_def425 = new BitSet(new long[]{0x0000000014A00002L});
	public static final BitSet FOLLOW_csRequest_def_in_controller_def437 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_controller_def439 = new BitSet(new long[]{0x0000000014200002L});
	public static final BitSet FOLLOW_csGeneratedInfo_def_in_controller_def450 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_controller_def452 = new BitSet(new long[]{0x0000000004200002L});
	public static final BitSet FOLLOW_cntrlCommand_def_in_controller_def464 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_controller_def466 = new BitSet(new long[]{0x0000000000200002L});
	public static final BitSet FOLLOW_14_in_csOperation_def497 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_csOperation_def499 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csOperation_def501 = new BitSet(new long[]{0x0000000000080000L});
	public static final BitSet FOLLOW_19_in_csOperation_def502 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_csOperation_def505 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_INT_in_csOperation_def507 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_csOperation_def509 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_26_in_csGeneratedInfoForAggregator_def533 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_csGeneratedInfoForAggregator_def535 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_csGeneratedInfoForAggregator_def537 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csGeneratedInfoForAggregator_def540 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_26_in_csGeneratedInfo_def559 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_csGeneratedInfo_def561 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_csGeneratedInfo_def563 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csGeneratedInfo_def566 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_23_in_csConsumeInfo_def594 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_csConsumeInfo_def596 = new BitSet(new long[]{0x0000000002000000L});
	public static final BitSet FOLLOW_25_in_csConsumeInfo_def599 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csConsumeInfo_def602 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_28_in_csRequest_def633 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_csRequest_def635 = new BitSet(new long[]{0x0000000080000000L});
	public static final BitSet FOLLOW_31_in_csRequest_def637 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csRequest_def639 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_21_in_cntrlCommand_def666 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def673 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_cntrlCommand_def675 = new BitSet(new long[]{0x0000000000000220L});
	public static final BitSet FOLLOW_cntrlParameter_def_in_cntrlCommand_def678 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_cntrlCommand_def682 = new BitSet(new long[]{0x0000000080000000L});
	public static final BitSet FOLLOW_31_in_cntrlCommand_def684 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def687 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_lc_id_in_cntrlParameter_def706 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_lc_id738 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_primitiveType_in_dataType753 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_17_in_primitiveType768 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_13_in_primitiveType774 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_18_in_primitiveType780 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_24_in_primitiveType789 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_27_in_primitiveType797 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_20_in_primitiveType803 = new BitSet(new long[]{0x0000000000000002L});
}
