...
<<<<<<< HEAD
	public static final String[] tokenNames = new String[] { "<invalid>",
			...
			"ID", "MOBILEFLAG", "WS", "'\"'", "','", "':'", "';'",
			"'database'", "'description'", "'devices'", "'location'",
...
<<<<<<< HEAD
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:23:1:
	// networkspec : 'devices' ':' ( device_def )* ;
	public final void networkspec() throws RecognitionException {
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:23:12:
			// ( 'devices' ':' ( device_def )* )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:24:7:
			// 'devices' ':' ( device_def )*
			{
				...
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:27:8:
				// ( device_def )*
				loop1: while (true) {
					int alt1 = 2;
					...
					switch (alt1) {
					case 1:
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:27:9:
					// device_def
					{
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:30:1:
	// device_def : deviceName= ( ID | CAPITALIZED_ID ) ':' 'location' ':' (
	// location_def )* 'platform' ':' ( device_type )* ';' 'resources' ':' (
	// abilities_def )? ';' 'protocol' ':' ( protocol_value )* ';' ( 'database'
	// ':' database_def ';' )* 'description' ':' ( description_def )* ';' ;
	public final void device_def() throws RecognitionException {
		Token deviceName = null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:30:11:
			// (deviceName= ( ID | CAPITALIZED_ID ) ':' 'location' ':' (
			// location_def )* 'platform' ':' ( device_type )* ';' 'resources'
			// ':' ( abilities_def )? ';' 'protocol' ':' ( protocol_value )* ';'
			// ( 'database' ':' database_def ';' )* 'description' ':' (
			// description_def )* ';' )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:31:4:
			// deviceName= ( ID | CAPITALIZED_ID ) ':' 'location' ':' (
			// location_def )* 'platform' ':' ( device_type )* ';' 'resources'
			// ':' ( abilities_def )? ';' 'protocol' ':' ( protocol_value )* ';'
			// ( 'database' ':' database_def ';' )* 'description' ':' (
			// description_def )* ';'
			{
				...
				match(input, 16, FOLLOW_16_in_device_def129);
				match(input, 11, FOLLOW_11_in_device_def131);
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:36:20:
				// ( location_def )*
				loop2: while (true) {
					int alt2 = 2;
					...
					switch (alt2) {
					case 1:
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:36:21:
					// location_def
					{
				...
				match(input, 17, FOLLOW_17_in_device_def143);
				match(input, 11, FOLLOW_11_in_device_def145);
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:37:20:
				// ( device_type )*
				loop3: while (true) {
					int alt3 = 2;
					...
					switch (alt3) {
					case 1:
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:37:21:
					// device_type
					{
				...
				match(input, 12, FOLLOW_12_in_device_def152);
				match(input, 19, FOLLOW_19_in_device_def159);
				match(input, 11, FOLLOW_11_in_device_def161);
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:38:21:
				// ( abilities_def )?
				int alt4 = 2;
				...
				switch (alt4) {
				case 1:
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:38:22:
				// abilities_def
				{
=======
	...
	// $ANTLR start "device_def"
	// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:30:1: device_def : deviceName= ( ID | CAPITALIZED_ID ) ':' 'location' ':' ( location_def )* 'platform' ':' ( device_type )* ';' 'resources' ':' ( abilities_def )? ';' 'protocol' ':' ( protocol_value )* ';' ( 'database' ':' database_def ';' )* 'description' ':' ( description_def )* ';' ;
	public final void device_def() throws RecognitionException {
		Token deviceName=null;

		try {
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:30:11: (deviceName= ( ID | CAPITALIZED_ID ) ':' 'location' ':' ( location_def )* 'platform' ':' ( device_type )* ';' 'resources' ':' ( abilities_def )? ';' 'protocol' ':' ( protocol_value )* ';' ( 'database' ':' database_def ';' )* 'description' ':' ( description_def )* ';' )
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:31:4: deviceName= ( ID | CAPITALIZED_ID ) ':' 'location' ':' ( location_def )* 'platform' ':' ( device_type )* ';' 'resources' ':' ( abilities_def )? ';' 'protocol' ':' ( protocol_value )* ';' ( 'database' ':' database_def ';' )* 'description' ':' ( description_def )* ';'
			{
			deviceName=input.LT(1);
			if ( input.LA(1)==CAPITALIZED_ID||input.LA(1)==ID ) {
				input.consume();
...
<<<<<<< HEAD
				...
				match(input, 12, FOLLOW_12_in_device_def169);
				match(input, 18, FOLLOW_18_in_device_def175);
				match(input, 11, FOLLOW_11_in_device_def177);
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:39:20:
				// ( protocol_value )*
				loop5: while (true) {
					int alt5 = 2;
					...
					switch (alt5) {
					case 1:
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:39:21:
					// protocol_value
					{
				...
				match(input, 12, FOLLOW_12_in_device_def184);
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:40:5:
				...
				loop6: while (true) {
					...
					switch (alt6) {
					case 1:
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:40:6:
					// 'database' ':' database_def ';'
					{
				...
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:41:25:
				// ( description_def )*
				loop7: while (true) {
					int alt7 = 2;
					...
					switch (alt7) {
					case 1:
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:41:26:
					// description_def
					{
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:45:1:
	...
	public final void location_def() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:45:14:
			// ( CAPITALIZED_ID ':' ID ';' )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:46:5:
			// CAPITALIZED_ID ':' ID ';'
			{
				CAPITALIZED_ID1 = (Token) match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_location_def262);
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:52:1:
	// device_type : CAPITALIZED_ID ;
	public final void device_type() throws RecognitionException {
		Token CAPITALIZED_ID3 = null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:52:13:
			// ( CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:53:6:
			// CAPITALIZED_ID
			{
				CAPITALIZED_ID3 = (Token) match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_device_type295);
				context.currentNetwork
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:57:1:
	...
	public final void abilities_def() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:57:15:
			// ( CAPITALIZED_ID ( ',' abilities_def )? )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:58:4:
			// CAPITALIZED_ID ( ',' abilities_def )?
			{
				CAPITALIZED_ID4 = (Token) match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_abilities_def314);
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:58:19:
				// ( ',' abilities_def )?
				int alt8 = 2;
				...
				switch (alt8) {
				case 1:
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:58:20:
				// ',' abilities_def
				{
...
=======
			...
			match(input,12,FOLLOW_12_in_device_def184); 
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:40:5: ( 'database' ':' database_def ';' )*
			loop6:
			while (true) {
				int alt6=2;
				int LA6_0 = input.LA(1);
	...
	// $ANTLR start "location_def"
	// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:45:1: location_def : CAPITALIZED_ID ':' ID ';' ;
	public final void location_def() throws RecognitionException {
		Token CAPITALIZED_ID1=null;
		Token ID2=null;
	...
	// $ANTLR start "device_type"
	// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:52:1: device_type : CAPITALIZED_ID ;
	public final void device_type() throws RecognitionException {
		Token CAPITALIZED_ID3=null;
	...
	// $ANTLR start "abilities_def"
	// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:57:1: abilities_def : CAPITALIZED_ID ( ',' abilities_def )? ;
	public final void abilities_def() throws RecognitionException {
		Token CAPITALIZED_ID4=null;
...
<<<<<<< HEAD
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:66:1:
	// protocol_value : ID ;
	public final void protocol_value() throws RecognitionException {
		Token ID5 = null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:66:15:
			// ( ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:67:3:
			// ID
			{
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:71:1:
	// description_def : '\"' DESCRIPTION_ID '\"' ;
	public final void description_def() throws RecognitionException {
		Token DESCRIPTION_ID6 = null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:71:16:
			// ( '\"' DESCRIPTION_ID '\"' )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:72:4:
			// '\"' DESCRIPTION_ID '\"'
			{
				match(input, 9, FOLLOW_9_in_description_def364);
				DESCRIPTION_ID6 = (Token) match(input, DESCRIPTION_ID,
						FOLLOW_DESCRIPTION_ID_in_description_def365);
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:76:1:
	// database_def : CAPITALIZED_ID ;
	public final void database_def() throws RecognitionException {
		Token CAPITALIZED_ID7 = null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:76:13:
			// ( CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:77:1:
			// CAPITALIZED_ID
			{
				CAPITALIZED_ID7 = (Token) match(input, CAPITALIZED_ID,
						FOLLOW_CAPITALIZED_ID_in_database_def383);
				context.currentNetwork
...
<<<<<<< HEAD
	public static final BitSet FOLLOW_15_in_networkspec58 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_networkspec60 = new BitSet(
	...
	public static final BitSet FOLLOW_set_in_device_def108 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_device_def114 = new BitSet(
			new long[] { 0x0000000000010000L });
	public static final BitSet FOLLOW_16_in_device_def129 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_device_def131 = new BitSet(
			new long[] { 0x0000000000020010L });
	public static final BitSet FOLLOW_location_def_in_device_def134 = new BitSet(
			new long[] { 0x0000000000020010L });
	public static final BitSet FOLLOW_17_in_device_def143 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_device_def145 = new BitSet(
			new long[] { 0x0000000000001010L });
	public static final BitSet FOLLOW_device_type_in_device_def148 = new BitSet(
			new long[] { 0x0000000000001010L });
	public static final BitSet FOLLOW_12_in_device_def152 = new BitSet(
			new long[] { 0x0000000000080000L });
	public static final BitSet FOLLOW_19_in_device_def159 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_device_def161 = new BitSet(
			new long[] { 0x0000000000001010L });
	public static final BitSet FOLLOW_abilities_def_in_device_def164 = new BitSet(
			new long[] { 0x0000000000001000L });
	public static final BitSet FOLLOW_12_in_device_def169 = new BitSet(
			new long[] { 0x0000000000040000L });
	public static final BitSet FOLLOW_18_in_device_def175 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_device_def177 = new BitSet(
			new long[] { 0x0000000000001040L });
	public static final BitSet FOLLOW_protocol_value_in_device_def180 = new BitSet(
			new long[] { 0x0000000000001040L });
	public static final BitSet FOLLOW_12_in_device_def184 = new BitSet(
			new long[] { 0x0000000000006000L });
	public static final BitSet FOLLOW_13_in_device_def192 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_device_def194 = new BitSet(
			new long[] { 0x0000000000000010L });
	public static final BitSet FOLLOW_database_def_in_device_def196 = new BitSet(
			new long[] { 0x0000000000001000L });
	public static final BitSet FOLLOW_12_in_device_def198 = new BitSet(
			new long[] { 0x0000000000006000L });
	public static final BitSet FOLLOW_14_in_device_def215 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_device_def217 = new BitSet(
			new long[] { 0x0000000000001200L });
	public static final BitSet FOLLOW_description_def_in_device_def221 = new BitSet(
			new long[] { 0x0000000000001200L });
	public static final BitSet FOLLOW_12_in_device_def226 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_location_def262 = new BitSet(
			new long[] { 0x0000000000000800L });
	public static final BitSet FOLLOW_11_in_location_def264 = new BitSet(
			new long[] { 0x0000000000000040L });
	public static final BitSet FOLLOW_ID_in_location_def266 = new BitSet(
			new long[] { 0x0000000000001000L });
	public static final BitSet FOLLOW_12_in_location_def268 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_device_type295 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_abilities_def314 = new BitSet(
			new long[] { 0x0000000000000402L });
	public static final BitSet FOLLOW_10_in_abilities_def317 = new BitSet(
			new long[] { 0x0000000000000010L });
	public static final BitSet FOLLOW_abilities_def_in_abilities_def319 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_ID_in_protocol_value345 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_9_in_description_def364 = new BitSet(
			new long[] { 0x0000000000000020L });
	public static final BitSet FOLLOW_DESCRIPTION_ID_in_description_def365 = new BitSet(
			new long[] { 0x0000000000000200L });
	public static final BitSet FOLLOW_9_in_description_def367 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_database_def383 = new BitSet(
			new long[] { 0x0000000000000002L });
=======
	...
	public static final BitSet FOLLOW_16_in_device_def129 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_device_def131 = new BitSet(new long[]{0x0000000000020010L});
	public static final BitSet FOLLOW_location_def_in_device_def134 = new BitSet(new long[]{0x0000000000020010L});
	public static final BitSet FOLLOW_17_in_device_def143 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_device_def145 = new BitSet(new long[]{0x0000000000001010L});
	public static final BitSet FOLLOW_device_type_in_device_def148 = new BitSet(new long[]{0x0000000000001010L});
	public static final BitSet FOLLOW_12_in_device_def152 = new BitSet(new long[]{0x0000000000080000L});
	public static final BitSet FOLLOW_19_in_device_def159 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_device_def161 = new BitSet(new long[]{0x0000000000001010L});
	public static final BitSet FOLLOW_abilities_def_in_device_def164 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_device_def169 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_18_in_device_def175 = new BitSet(new long[]{0x0000000000000800L});
