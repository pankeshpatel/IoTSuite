...
public class NetworkSpecParser extends Parser {
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:30:1: device_def : deviceName= ( ID | CAPITALIZED_ID ) ':' 'location' ':' ( location_def )* 'platform' ':' ( device_type )* ';' 'resources' ':' ( abilities_def )? ';' 'protocol' ':' ( protocol_value )* ';' 'description' ':' ( description_def )* ';' ( 'database' ':' database_def ';' )* ;
	public final void device_def() throws RecognitionException {
		Token deviceName=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:30:11: (deviceName= ( ID | CAPITALIZED_ID ) ':' 'location' ':' ( location_def )* 'platform' ':' ( device_type )* ';' 'resources' ':' ( abilities_def )? ';' 'protocol' ':' ( protocol_value )* ';' 'description' ':' ( description_def )* ';' ( 'database' ':' database_def ';' )* )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:31:4: deviceName= ( ID | CAPITALIZED_ID ) ':' 'location' ':' ( location_def )* 'platform' ':' ( device_type )* ';' 'resources' ':' ( abilities_def )? ';' 'protocol' ':' ( protocol_value )* ';' 'description' ':' ( description_def )* ';' ( 'database' ':' database_def ';' )*
			{
			...
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:40:25: ( description_def )*
			loop6:
			while (true) {
				int alt6=2;
				...
				switch (alt6) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:40:26: description_def
					{
			...
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:41:6: ( 'database' ':' database_def ';' )*
			loop7:
			while (true) {
				int alt7=2;
				...
				switch (alt7) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:41:7: 'database' ':' database_def ';'
					{
	...
	public final void location_def() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID1=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_location_def245); 
	...
	public final void device_type() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID3=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_device_type278); 
	...
	public final void abilities_def() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID4=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_abilities_def297); 
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:63:1: protocol_value : ID ;
	public final void protocol_value() throws RecognitionException {
		Token ID5=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:63:15: ( ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:64:3: ID
			{
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:68:1: description_def : DESCRIPTION_ID ;
	public final void description_def() throws RecognitionException {
		Token DESCRIPTION_ID6=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:68:16: ( DESCRIPTION_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:69:4: DESCRIPTION_ID
			{
			DESCRIPTION_ID6=(Token)match(input,DESCRIPTION_ID,FOLLOW_DESCRIPTION_ID_in_description_def338); 
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:73:1: database_def : CAPITALIZED_ID ;
	public final void database_def() throws RecognitionException {
		Token CAPITALIZED_ID7=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:73:13: ( CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:74:1: CAPITALIZED_ID
			{
			CAPITALIZED_ID7=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_database_def354); 
	...
	public static final BitSet FOLLOW_14_in_networkspec58 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_networkspec60 = new BitSet(new long[]{0x0000000000000052L});
	...
	public static final BitSet FOLLOW_10_in_device_def114 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_device_def129 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_device_def131 = new BitSet(new long[]{0x0000000000010010L});
	public static final BitSet FOLLOW_location_def_in_device_def134 = new BitSet(new long[]{0x0000000000010010L});
	public static final BitSet FOLLOW_16_in_device_def143 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_device_def145 = new BitSet(new long[]{0x0000000000000810L});
	public static final BitSet FOLLOW_device_type_in_device_def148 = new BitSet(new long[]{0x0000000000000810L});
	public static final BitSet FOLLOW_11_in_device_def152 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_18_in_device_def159 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_device_def161 = new BitSet(new long[]{0x0000000000000810L});
	public static final BitSet FOLLOW_abilities_def_in_device_def164 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_device_def169 = new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_17_in_device_def175 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_device_def177 = new BitSet(new long[]{0x0000000000000840L});
	public static final BitSet FOLLOW_protocol_value_in_device_def180 = new BitSet(new long[]{0x0000000000000840L});
	public static final BitSet FOLLOW_11_in_device_def184 = new BitSet(new long[]{0x0000000000002000L});
	public static final BitSet FOLLOW_13_in_device_def196 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_device_def198 = new BitSet(new long[]{0x0000000000000820L});
	public static final BitSet FOLLOW_description_def_in_device_def202 = new BitSet(new long[]{0x0000000000000820L});
	public static final BitSet FOLLOW_11_in_device_def206 = new BitSet(new long[]{0x0000000000001002L});
	public static final BitSet FOLLOW_12_in_device_def214 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_device_def216 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_database_def_in_device_def218 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_device_def220 = new BitSet(new long[]{0x0000000000001002L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_location_def245 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_location_def247 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_ID_in_location_def249 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_location_def251 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_device_type278 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_abilities_def297 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_9_in_abilities_def300 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_abilities_def_in_abilities_def302 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_protocol_value319 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_DESCRIPTION_ID_in_description_def338 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_database_def354 = new BitSet(new long[]{0x0000000000000002L});
}
