...
public class NetworkSpecParser extends Parser {
	public static final String[] tokenNames = new String[] {
		...
		"WS", "','", "':'", "';'", "'database'", "'description'", "'devices'", 
		"'location'", "'platform'", "'protocol'", "'resources'"
	};
	...
	public final void networkspec() throws RecognitionException {
		try {
			...
			{
			match(input,13,FOLLOW_13_in_networkspec58); 
	...
	public final void device_def() throws RecognitionException {
		...
		try {
			...
			match(input,17,FOLLOW_17_in_device_def159); 
			...
			match(input,16,FOLLOW_16_in_device_def175); 
			...
			match(input,12,FOLLOW_12_in_device_def196); 
			...
			while (true) {
				...
				case 1 :
					...
					match(input,9,FOLLOW_9_in_device_def216); 
					pushFollow(FOLLOW_database_def_in_device_def218);
					database_def();
					state._fsp--;

					match(input,10,FOLLOW_10_in_device_def220); 
					}
					break;
	...
	public final void location_def() throws RecognitionException {
		...
		try {
			...
			match(input,9,FOLLOW_9_in_location_def247); 
			ID2=(Token)match(input,ID,FOLLOW_ID_in_location_def249); 
			match(input,10,FOLLOW_10_in_location_def251); 
		...
		try {
			...
			switch (alt8) {
				case 1 :
					...
					{
					match(input,8,FOLLOW_8_in_abilities_def300); 
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:68:1: description_def : CAPITALIZED_ID ;
	public final void description_def() throws RecognitionException {
		Token CAPITALIZED_ID6=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:68:16: ( CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:69:4: CAPITALIZED_ID
			{
			CAPITALIZED_ID6=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_description_def338); 
	...
	public static final BitSet FOLLOW_13_in_networkspec58 = new BitSet(new long[]{0x0000000000000200L});
	...
	public static final BitSet FOLLOW_9_in_device_def114 = new BitSet(new long[]{0x0000000000004000L});
	...
	public static final BitSet FOLLOW_10_in_device_def152 = new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_17_in_device_def159 = new BitSet(new long[]{0x0000000000000200L});
	...
	public static final BitSet FOLLOW_10_in_device_def169 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_16_in_device_def175 = new BitSet(new long[]{0x0000000000000200L});
	...
	public static final BitSet FOLLOW_10_in_device_def184 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_device_def196 = new BitSet(new long[]{0x0000000000000200L});
	...
	public static final BitSet FOLLOW_10_in_device_def206 = new BitSet(new long[]{0x0000000000000802L});
	public static final BitSet FOLLOW_11_in_device_def214 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_device_def216 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_database_def_in_device_def218 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_device_def220 = new BitSet(new long[]{0x0000000000000802L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_location_def245 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_location_def247 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ID_in_location_def249 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_location_def251 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_device_type278 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_abilities_def297 = new BitSet(new long[]{0x0000000000000102L});
	public static final BitSet FOLLOW_8_in_abilities_def300 = new BitSet(new long[]{0x0000000000000010L});
	...
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_description_def338 = new BitSet(new long[]{0x0000000000000002L});
