...
public class NetworkSpecLexer extends Lexer {
	...
	public final void mT__13() throws RecognitionException {
		try {
			int _type = T__13;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:15:7:
			// ( 'description' )
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:15:9:
			// 'description'
			{
				match("description");
	...
	public final void mT__14() throws RecognitionException {
		try {
			int _type = T__14;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:16:7:
			// ( 'devices' )
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:16:9:
			// 'devices'
			{
				match("devices");
	...
	public final void mT__15() throws RecognitionException {
		try {
			int _type = T__15;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:17:7:
			// ( 'location' )
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:17:9:
			// 'location'
			{
				match("location");
	...
	public final void mT__16() throws RecognitionException {
		try {
			int _type = T__16;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:18:7:
			// ( 'platform' )
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:18:9:
			// 'platform'
			{
				match("platform");
	...
	public final void mT__17() throws RecognitionException {
		try {
			int _type = T__17;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:19:7:
			// ( 'protocol' )
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:19:9:
			// 'protocol'
			{
				match("protocol");
	...
	public final void mT__18() throws RecognitionException {
		try {
			int _type = T__18;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:20:7:
			// ( 'resources' )
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:20:9:
			// 'resources'
			{
				match("resources");
	...
	public final void mMOBILEFLAG() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:78:12:
			// ( 'true' | 'false' )
			int alt1 = 2;
			...
			switch (alt1) {
			case 1:
				// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:78:15:
				// 'true'
			{
				match("true");
				...
				break;
			case 2:
				// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:78:24:
				// 'false'
			{
				match("false");
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:83:5:
			// ( ( 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' )* ( '0' .. '9' )* ) |
			// '0' .. '9' ( '0' .. '9' )* | '*' )
			int alt5 = 3;
			switch (input.LA(1)) {
			...
			switch (alt5) {
			case 1:
				// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:83:7:
				// ( 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' )* ( '0' .. '9' )* )
			{
				// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:83:7:
				// ( 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' )* ( '0' .. '9' )* )
				// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:83:8:
				// 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' )* ( '0' .. '9' )*
				{
					matchRange('a', 'z');
					// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:83:18:
					// ( 'a' .. 'z' | 'A' .. 'Z' )*
					loop2: while (true) {
						int alt2 = 2;
					...
					// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:83:42:
					// ( '0' .. '9' )*
					loop3: while (true) {
						int alt3 = 2;
				...
				break;
			case 2:
				// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:83:56:
				// '0' .. '9' ( '0' .. '9' )*
			{
				matchRange('0', '9');
				// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:83:64:
				// ( '0' .. '9' )*
				loop4: while (true) {
					int alt4 = 2;
	...
	public final void mDESCRIPTION_ID() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:85:15:
			// ( ( 'a' .. 'z' | '0' .. '9' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' ..
			// '9' | ' ' )* )
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:85:19:
			// ( 'a' .. 'z' | '0' .. '9' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' ..
			// '9' | ' ' )*
			{
				if ((input.LA(1) >= '0' && input.LA(1) <= '9')
				...
				// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:85:38:
				// ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | ' ' )*
				loop6: while (true) {
					int alt6 = 2;
	...
	public final void mCAPITALIZED_ID() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:87:15:
			// ( 'A' .. 'Z' ( 'a' .. 'z' | 'A' .. 'Z' )* ( '0' .. '9' )* )
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:87:17:
			// 'A' .. 'Z' ( 'a' .. 'z' | 'A' .. 'Z' )* ( '0' .. '9' )*
			{
				matchRange('A', 'Z');
				// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:87:26:
				// ( 'a' .. 'z' | 'A' .. 'Z' )*
				loop7: while (true) {
					int alt7 = 2;
				...
				// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:87:50:
				// ( '0' .. '9' )*
				loop8: while (true) {
					int alt8 = 2;
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:90:3:
			// ( ( '\\t' | ' ' | '\\r' | '\\n' | '\ ' )+ )
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:90:5:
			// ( '\\t' | ' ' | '\\r' | '\\n' | '\ ' )+
			{
				// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:90:5:
				// ( '\\t' | ' ' | '\\r' | '\\n' | '\ ' )+
	...
	public void mTokens() throws RecognitionException {
		// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:8: (
		// T__9 | T__10 | T__11 | T__12 | T__13 | T__14 | T__15 | T__16 | T__17
		// | T__18 | MOBILEFLAG | ID | DESCRIPTION_ID | CAPITALIZED_ID | WS )
		int alt10 = 15;
		alt10 = dfa10.predict(input);
		switch (alt10) {
		case 1:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:10:
			// T__9
		{
			mT__9();
			...
			break;
		case 2:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:15:
			// T__10
		{
			mT__10();
			...
			break;
		case 3:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:21:
			// T__11
		{
			mT__11();
			...
			break;
		case 4:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:27:
			// T__12
		{
			mT__12();
			...
			break;
		case 5:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:33:
			// T__13
		{
			mT__13();
			...
			break;
		case 6:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:39:
			// T__14
		{
			mT__14();
			...
			break;
		case 7:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:45:
			// T__15
		{
			mT__15();
			...
			break;
		case 8:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:51:
			// T__16
		{
			mT__16();
			...
			break;
		case 9:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:57:
			// T__17
		{
			mT__17();
			...
			break;
		case 10:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:63:
			// T__18
		{
			mT__18();
			...
			break;
		case 11:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:69:
			// MOBILEFLAG
		{
			mMOBILEFLAG();
			...
			break;
		case 12:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:80:
			// ID
		{
			mID();
			...
			break;
		case 13:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:83:
			// DESCRIPTION_ID
		{
			mDESCRIPTION_ID();
			...
			break;
		case 14:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:98:
			// CAPITALIZED_ID
		{
			mCAPITALIZED_ID();
			...
			break;
		case 15:
			// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:113:
			// WS
		{
			mWS();
	...
	static final String DFA10_eotS = "\4\uffff\10\14\3\uffff\4\14\1\uffff\27\14\1\64\10\14\1\uffff\1\64\11\14"
			+ "\1\106\4\14\1\113\1\14\1\uffff\1\115\1\116\1\117\1\14\1\uffff\1\14\3\uffff"
			+ "\1\122\1\14\1\uffff\1\124\1\uffff";
	static final String DFA10_eofS = "\125\uffff";
	static final String DFA10_minS = "\1\11\3\uffff\10\40\3\uffff\4\40\1\uffff\40\40\1\uffff\21\40\1\uffff\4"
			+ "\40\1\uffff\1\40\3\uffff\2\40\1\uffff\1\40\1\uffff";
	static final String DFA10_maxS = "\1\172\3\uffff\10\172\3\uffff\4\172\1\uffff\40\172\1\uffff\21\172\1\uffff"
			+ "\4\172\1\uffff\1\172\3\uffff\2\172\1\uffff\1\172\1\uffff";
	static final String DFA10_acceptS = "\1\uffff\1\1\1\2\1\3\10\uffff\1\14\1\16\1\17\4\uffff\1\15\40\uffff\1\13"
			+ "\21\uffff\1\6\4\uffff\1\4\1\uffff\1\7\1\10\1\11\2\uffff\1\12\1\uffff\1"
			+ "\5";
	static final String DFA10_specialS = "\125\uffff}>";
