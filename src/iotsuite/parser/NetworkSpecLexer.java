// $ANTLR 3.5.1 S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g 2015-11-21 13:06:43
...
public class NetworkSpecLexer extends Lexer {
	...
	public final void mMOBILEFLAG() throws RecognitionException {
		try {
			...
			// 'true'
			{
				...
				break;
			case 2:
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:81:24:
			// 'false'
			{
				match("false");
	...
	public final void mID() throws RecognitionException {
		try {
			...
			switch (alt5) {
			case 1:
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:86:7:
			// ( 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' )* ( '0' .. '9' )* )
			{
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:86:7:
				// ( 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' )* ( '0' .. '9' )* )
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:86:8:
				// 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' )* ( '0' .. '9' )*
				{
					matchRange('a', 'z');
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:86:18:
					// ( 'a' .. 'z' | 'A' .. 'Z' )*
					loop2: while (true) {
						int alt2 = 2;
				...
				break;
			case 2:
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:86:56:
			// '0' .. '9' ( '0' .. '9' )*
			{
				matchRange('0', '9');
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:86:64:
				// ( '0' .. '9' )*
				loop4: while (true) {
					int alt4 = 2;
	...
	public final void mDESCRIPTION_ID() throws RecognitionException {
		try {
			...
			// ( ( 'a' .. 'z' | '0' .. '9' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' ..
			// '9' | ' ' )* )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:88:19:
			// ( 'a' .. 'z' | '0' .. '9' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' ..
			// '9' | ' ' )*
			{
				if ((input.LA(1) >= '0' && input.LA(1) <= '9')
				...
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:88:38:
				// ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | ' ' )*
				loop6: while (true) {
					int alt6 = 2;
	...
	public final void mCAPITALIZED_ID() throws RecognitionException {
		try {
			...
			{
				matchRange('A', 'Z');
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:90:26:
				// ( 'a' .. 'z' | 'A' .. 'Z' )*
				loop7: while (true) {
					int alt7 = 2;
				...
				// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:90:50:
				// ( '0' .. '9' )*
				loop8: while (true) {
					int alt8 = 2;
	...
	public void mTokens() throws RecognitionException {
		...
		switch (alt10) {
		case 1:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:10:
		// T__9
		{
			mT__9();
			...
			break;
		case 2:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:15:
		// T__10
		{
			mT__10();
			...
			break;
		case 3:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:21:
		// T__11
		{
			mT__11();
			...
			break;
		case 4:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:27:
		// T__12
		{
			mT__12();
			...
			break;
		case 5:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:33:
		// T__13
		{
			mT__13();
			...
			break;
		case 6:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:39:
		// T__14
		{
			mT__14();
			...
			break;
		case 7:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:45:
		// T__15
		{
			mT__15();
			...
			break;
		case 8:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:51:
		// T__16
		{
			mT__16();
			...
			break;
		case 9:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:57:
		// T__17
		{
			mT__17();
			...
			break;
		case 10:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:63:
		// T__18
		{
			mT__18();
			...
			break;
		case 11:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:69:
		// T__19
		{
			mT__19();
			...
			break;
		case 12:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:75:
		// MOBILEFLAG
		{
			mMOBILEFLAG();
			...
			break;
		case 13:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:86:
		// ID
		{
			mID();
			...
			break;
		case 14:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:89:
		// DESCRIPTION_ID
		{
			mDESCRIPTION_ID();
			...
			break;
		case 15:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:104:
		// CAPITALIZED_ID
		{
			mCAPITALIZED_ID();
			...
			break;
		case 16:
		// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:1:119:
		// WS
		{
			mWS();
	...
	static final String DFA10_eofS = "\126\uffff";
	static final String DFA10_minS = "\1\11\4\uffff\10\40\3\uffff\4\40\1\uffff\40\40\1\uffff\21\40\1\uffff\4"
			+ "\40\1\uffff\1\40\3\uffff\2\40\1\uffff\1\40\1\uffff";
	static final String DFA10_maxS = "\1\172\4\uffff\10\172\3\uffff\4\172\1\uffff\40\172\1\uffff\21\172\1\uffff"
			+ "\4\172\1\uffff\1\172\3\uffff\2\172\1\uffff\1\172\1\uffff";
	static final String DFA10_acceptS = "\1\uffff\1\1\1\2\1\3\1\4\10\uffff\1\15\1\17\1\20\4\uffff\1\16\40\uffff"
			+ "\1\14\21\uffff\1\7\4\uffff\1\5\1\uffff\1\10\1\11\1\12\2\uffff\1\13\1\uffff"
			+ "\1\6";
	static final String DFA10_specialS = "\126\uffff}>";
