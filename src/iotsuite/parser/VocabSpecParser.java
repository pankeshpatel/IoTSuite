// $ANTLR 3.5.1 C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\VocabSpec.g 2015-11-07 10:32:19
...
public class VocabSpecParser extends Parser {
	...
	public final void periodicsensor_def() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID4=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_periodicsensor_def270); 
	...
	public final void eventsensor_def() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID5=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_eventsensor_def314); 
	...
	public final void sensorMeasurementForEventDriven_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,24,FOLLOW_24_in_sensorMeasurementForEventDriven_def358); 
			pushFollow(FOLLOW_lc_id_in_sensorMeasurementForEventDriven_def360);
			lc_id6=lc_id();
			state._fsp--;

			match(input,11,FOLLOW_11_in_sensorMeasurementForEventDriven_def362); 
			CAPITALIZED_ID7=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_sensorMeasurementForEventDriven_def365); 
	...
	public final void sensorMeasurementForPeriodic_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,24,FOLLOW_24_in_sensorMeasurementForPeriodic_def388); 
			pushFollow(FOLLOW_lc_id_in_sensorMeasurementForPeriodic_def390);
			lc_id8=lc_id();
			state._fsp--;

			match(input,11,FOLLOW_11_in_sensorMeasurementForPeriodic_def392); 
			CAPITALIZED_ID9=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_sensorMeasurementForPeriodic_def395); 
	...
	public final void sample_period_def() throws RecognitionException {
		...
		try {
			...
			{
			INT10=(Token)match(input,INT,FOLLOW_INT_in_sample_period_def447); 
	...
	public final void sample_duration_def() throws RecognitionException {
		...
		try {
			...
			{
			INT11=(Token)match(input,INT,FOLLOW_INT_in_sample_duration_def460); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\VocabSpec.g:114:2: 'onCondition' ( ID | ',' ID )*
					{
					match(input,26,FOLLOW_26_in_sensoreventMeasurement_def472); 
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,ID,FOLLOW_ID_in_sensoreventMeasurement_def475); 
							}
							break;
						case 2 :
							// C:\\IoTSuite\\IoTSuite\\src\\iotsuite\\parser\\VocabSpec.g:114:21: ',' ID
							{
							match(input,10,FOLLOW_10_in_sensoreventMeasurement_def478); 
							match(input,ID,FOLLOW_ID_in_sensoreventMeasurement_def480); 
							}
							break;
	...
	public final void actuator_def() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID12=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_actuator_def495); 
	...
	public final void action_def() throws RecognitionException {
		...
		try {
			...
			CAPITALIZED_ID13=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_action_def533); 
	...
	public final void parameter_def() throws RecognitionException {
		...
		try {
			...
			CAPITALIZED_ID14=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_parameter_def567); 
	...
	public final void ss_def() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID16=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_ss_def590); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_storageDataAccess_def_in_ss_def605);
					storageDataAccess_def();
					state._fsp--;

					match(input,12,FOLLOW_12_in_ss_def607); 
					}
					break;
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_storageActionAccess_def_in_ss_def616);
					storageActionAccess_def();
					state._fsp--;

					match(input,12,FOLLOW_12_in_ss_def618); 
					}
					break;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_storageAction_def_in_storageActionAccess_def641);
					storageAction_def();
					state._fsp--;
	...
	public final void storageAction_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,18,FOLLOW_18_in_storageAction_def666); 
			CAPITALIZED_ID17=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_storageAction_def668); 
			match(input,8,FOLLOW_8_in_storageAction_def670); 
			...
			switch (alt24) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_storageParameter_def_in_storageAction_def673);
			...
			match(input,9,FOLLOW_9_in_storageAction_def677); 
	...
	public final void storageParameter_def() throws RecognitionException {
		...
		try {
			...
			{
			pushFollow(FOLLOW_lc_id_in_storageParameter_def697);
			lc_id19=lc_id();
			state._fsp--;

			match(input,11,FOLLOW_11_in_storageParameter_def699); 
			CAPITALIZED_ID18=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_storageParameter_def702); 
			...
			switch (alt25) {
				case 1 :
					...
					{
					match(input,10,FOLLOW_10_in_storageParameter_def705); 
					pushFollow(FOLLOW_storageParameter_def_in_storageParameter_def707);
					storageParameter_def();
					state._fsp--;
	...
	public final void storageDataAccess_def() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_storageGeneratedInfo_def_in_storageDataAccess_def732);
			storageGeneratedInfo_def();
			state._fsp--;

			match(input,17,FOLLOW_17_in_storageDataAccess_def735); 
			pushFollow(FOLLOW_storagedataIndex_def_in_storageDataAccess_def737);
	...
	public final void storageGeneratedInfo_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,24,FOLLOW_24_in_storageGeneratedInfo_def756); 
			pushFollow(FOLLOW_lc_id_in_storageGeneratedInfo_def758);
			lc_id21=lc_id();
			state._fsp--;

			match(input,11,FOLLOW_11_in_storageGeneratedInfo_def760); 
			CAPITALIZED_ID20=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_storageGeneratedInfo_def763); 
	...
	public final void storagedataIndex_def() throws RecognitionException {
		...
		try {
			...
			{
			pushFollow(FOLLOW_lc_id_in_storagedataIndex_def785);
			lc_id22=lc_id();
			state._fsp--;

			match(input,11,FOLLOW_11_in_storagedataIndex_def787); 
			pushFollow(FOLLOW_dataType_in_storagedataIndex_def789);
			dataType23=dataType();
			state._fsp--;
	...
	public final VocabSpecParser.lc_id_return lc_id() throws RecognitionException {
		...
		try {
			...
			{
			match(input,ID,FOLLOW_ID_in_lc_id807); 
			}
	...
	public final VocabSpecParser.dataType_return dataType() throws RecognitionException {
		...
		try {
			...
			{
			pushFollow(FOLLOW_primitiveType_in_dataType820);
			primitiveType();
			state._fsp--;
	...
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_periodicsensor_def270 = new BitSet(new long[]{0x0000000041000002L});
	public static final BitSet FOLLOW_sensorMeasurementForPeriodic_def_in_periodicsensor_def283 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_periodicsensor_def285 = new BitSet(new long[]{0x0000000041000002L});
	public static final BitSet FOLLOW_sensorperiodicMeasurement_def_in_periodicsensor_def295 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_periodicsensor_def297 = new BitSet(new long[]{0x0000000040000002L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_eventsensor_def314 = new BitSet(new long[]{0x0000000005001002L});
	public static final BitSet FOLLOW_sensorMeasurementForEventDriven_def_in_eventsensor_def327 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_eventsensor_def329 = new BitSet(new long[]{0x0000000005001002L});
	public static final BitSet FOLLOW_sensoreventMeasurement_def_in_eventsensor_def339 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_eventsensor_def341 = new BitSet(new long[]{0x0000000004001002L});
	public static final BitSet FOLLOW_24_in_sensorMeasurementForEventDriven_def358 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_sensorMeasurementForEventDriven_def360 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_sensorMeasurementForEventDriven_def362 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_sensorMeasurementForEventDriven_def365 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_24_in_sensorMeasurementForPeriodic_def388 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_sensorMeasurementForPeriodic_def390 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_sensorMeasurementForPeriodic_def392 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_sensorMeasurementForPeriodic_def395 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_30_in_sensorperiodicMeasurement_def420 = new BitSet(new long[]{0x0000000008000000L});
	public static final BitSet FOLLOW_27_in_sensorperiodicMeasurement_def422 = new BitSet(new long[]{0x0000000000800040L});
	public static final BitSet FOLLOW_sample_period_def_in_sensorperiodicMeasurement_def425 = new BitSet(new long[]{0x0000000000800040L});
	public static final BitSet FOLLOW_23_in_sensorperiodicMeasurement_def429 = new BitSet(new long[]{0x0000000000000042L});
	public static final BitSet FOLLOW_sample_duration_def_in_sensorperiodicMeasurement_def432 = new BitSet(new long[]{0x0000000000000042L});
	public static final BitSet FOLLOW_INT_in_sample_period_def447 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INT_in_sample_duration_def460 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_26_in_sensoreventMeasurement_def472 = new BitSet(new long[]{0x0000000004000422L});
	public static final BitSet FOLLOW_ID_in_sensoreventMeasurement_def475 = new BitSet(new long[]{0x0000000004000422L});
	public static final BitSet FOLLOW_10_in_sensoreventMeasurement_def478 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ID_in_sensoreventMeasurement_def480 = new BitSet(new long[]{0x0000000004000422L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_actuator_def495 = new BitSet(new long[]{0x0000000000040002L});
	public static final BitSet FOLLOW_action_def_in_actuator_def507 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_actuator_def509 = new BitSet(new long[]{0x0000000000040002L});
	public static final BitSet FOLLOW_18_in_action_def531 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_action_def533 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_action_def535 = new BitSet(new long[]{0x0000000000000220L});
	public static final BitSet FOLLOW_parameter_def_in_action_def538 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_action_def542 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_lc_id_in_parameter_def562 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_parameter_def564 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_parameter_def567 = new BitSet(new long[]{0x0000000000000402L});
	public static final BitSet FOLLOW_10_in_parameter_def570 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_parameter_def_in_parameter_def572 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_ss_def590 = new BitSet(new long[]{0x0000000001041002L});
	public static final BitSet FOLLOW_storageDataAccess_def_in_ss_def605 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_ss_def607 = new BitSet(new long[]{0x0000000001041002L});
	public static final BitSet FOLLOW_storageActionAccess_def_in_ss_def616 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_ss_def618 = new BitSet(new long[]{0x0000000000041002L});
	public static final BitSet FOLLOW_storageAction_def_in_storageActionAccess_def641 = new BitSet(new long[]{0x0000000000040002L});
	public static final BitSet FOLLOW_18_in_storageAction_def666 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_storageAction_def668 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_storageAction_def670 = new BitSet(new long[]{0x0000000000000220L});
	public static final BitSet FOLLOW_storageParameter_def_in_storageAction_def673 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_storageAction_def677 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_lc_id_in_storageParameter_def697 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_storageParameter_def699 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_storageParameter_def702 = new BitSet(new long[]{0x0000000000000402L});
	public static final BitSet FOLLOW_10_in_storageParameter_def705 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_storageParameter_def_in_storageParameter_def707 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_storageGeneratedInfo_def_in_storageDataAccess_def732 = new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_17_in_storageDataAccess_def735 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_storagedataIndex_def_in_storageDataAccess_def737 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_24_in_storageGeneratedInfo_def756 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_storageGeneratedInfo_def758 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_storageGeneratedInfo_def760 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_storageGeneratedInfo_def763 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_lc_id_in_storagedataIndex_def785 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_storagedataIndex_def787 = new BitSet(new long[]{0x000000000231E000L});
	public static final BitSet FOLLOW_dataType_in_storagedataIndex_def789 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_lc_id807 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_primitiveType_in_dataType820 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_14_in_primitiveType835 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_13_in_primitiveType841 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_15_in_primitiveType847 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_21_in_primitiveType856 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_25_in_primitiveType864 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_20_in_primitiveType870 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_16_in_primitiveType875 = new BitSet(new long[]{0x0000000000000002L});
}
