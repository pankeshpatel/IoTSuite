...
*/
	...
	public TempConsumeInfo(String tempConsumeInfoName,
			String tempConsumeInfoType, List<ConsumeInfo> tempListOfSingleConsumeInfo ) {
		super();
		this.tempConsumeInfoName = tempConsumeInfoName;
...
/*	public String getTempConsumInfoStructFieldName() {
		return tempConsumInfoStructFieldName;
	}

	public void setTempConsumInfoStructFieldName(
			String tempConsumInfoStructFieldName) {
		this.tempConsumInfoStructFieldName = tempConsumInfoStructFieldName;
	}

	public String getTempConsumInfoStructFieldType() {
		return tempConsumInfoStructFieldType;
	}

	public void setTempConsumInfoStructFieldType(
			String tempConsumInfoStructFieldType) {
		this.tempConsumInfoStructFieldType = tempConsumInfoStructFieldType;
	}*/

	/*public TempConsumeInfo(String tempConsumeInfoName,
			String tempConsumeInfoType, String tempConsumInfoStructFieldName,
			String tempConsumInfoStructFieldType) {
		super();
		this.tempConsumeInfoName = tempConsumeInfoName;
		this.tempConsumeInfoType = tempConsumeInfoType;
